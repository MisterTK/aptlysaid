...
BEGIN
  ...
  FOR v_message IN 
    ...
    FROM pgmq.q_response_approval_queue
...
BEGIN
  ...
  WHERE EXISTS (
    SELECT 1 FROM pgmq.read_with_poll(p_queue_name, 1000, 1, 0) m
  ...
  available_messages AS (
    ...
    FROM pgmq.read_with_poll(p_queue_name, p_batch_size * 10, 300, 0) m
...
BEGIN
  ...
  SELECT 
    ...
    ws.workflow_type,
    ws.step_name,
    EXISTS(SELECT 1 FROM pgmq.meta m WHERE m.queue_name = ws.queue_name) as is_active
...
CREATE OR REPLACE FUNCTION "public"."pgmq_delete_message"("p_queue_name" "text", "p_msg_id" bigint) RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
...
ALTER FUNCTION "public"."pgmq_delete_message"("p_queue_name" "text", "p_msg_id" bigint) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_ai_generation"("p_vt" integer DEFAULT 120, "p_qty" integer DEFAULT 2) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
BEGIN
  RETURN QUERY
  SELECT * FROM pgmq.read('ai_generation_queue', p_vt, p_qty);
END;
$$;


ALTER FUNCTION "public"."pgmq_read_ai_generation"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_customer_onboarding"("p_vt" integer DEFAULT 300, "p_qty" integer DEFAULT 5) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
  RETURN QUERY
  SELECT * FROM pgmq.read('customer_onboarding_queue', p_vt, p_qty);
END;
$$;


ALTER FUNCTION "public"."pgmq_read_customer_onboarding"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_location_discovery"("p_vt" integer, "p_qty" integer) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "sql"
    SET "search_path" TO ''
    AS $$
  SELECT * FROM pgmq.read('location_discovery_queue', p_vt, p_qty);
$$;


ALTER FUNCTION "public"."pgmq_read_location_discovery"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_location_sync"("p_vt" integer, "p_qty" integer) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "sql"
    SET "search_path" TO ''
    AS $$
  SELECT * FROM pgmq.read('location_sync_queue', p_vt, p_qty);
$$;


ALTER FUNCTION "public"."pgmq_read_location_sync"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_oauth_validation"("p_vt" integer DEFAULT 30, "p_qty" integer DEFAULT 5) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
BEGIN
  RETURN QUERY
  SELECT * FROM pgmq.read('oauth_validation_queue', p_vt, p_qty);
END;
$$;


ALTER FUNCTION "public"."pgmq_read_oauth_validation"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_response_approval"("p_vt" integer DEFAULT 300, "p_qty" integer DEFAULT 10) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  SELECT * FROM pgmq.read('response_approval_queue', p_vt, p_qty);
$$;


ALTER FUNCTION "public"."pgmq_read_response_approval"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_response_publishing"("p_vt" integer DEFAULT 60, "p_qty" integer DEFAULT 5) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
BEGIN
  RETURN QUERY
  SELECT * FROM pgmq.read('response_publishing_queue', p_vt, p_qty);
END;
$$;


ALTER FUNCTION "public"."pgmq_read_response_publishing"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_read_review_sync"("p_vt" integer DEFAULT 60, "p_qty" integer DEFAULT 3) RETURNS TABLE("msg_id" bigint, "read_ct" integer, "enqueued_at" timestamp with time zone, "vt" timestamp with time zone, "message" "jsonb")
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
BEGIN
  RETURN QUERY
  SELECT * FROM pgmq.read('review_sync_queue', p_vt, p_qty);
END;
$$;


ALTER FUNCTION "public"."pgmq_read_review_sync"("p_vt" integer, "p_qty" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_send_message"("p_queue_name" "text", "p_message" "jsonb", "p_delay_seconds" integer DEFAULT 0) RETURNS bigint
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
  IF p_delay_seconds > 0 THEN
    RETURN pgmq.send(p_queue_name, p_message, (NOW() + (p_delay_seconds || ' seconds')::INTERVAL));
  ELSE
    RETURN pgmq.send(p_queue_name, p_message);
  END IF;
END;
$$;


ALTER FUNCTION "public"."pgmq_send_message"("p_queue_name" "text", "p_message" "jsonb", "p_delay_seconds" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pgmq_send_response_publishing"("p_message" "jsonb") RETURNS bigint
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  SELECT pgmq.send('response_publishing_queue', p_message);
$$;


ALTER FUNCTION "public"."pgmq_send_response_publishing"("p_message" "jsonb") OWNER TO "postgres";
...
BEGIN
  ...
  PERFORM pgmq.archive(p_queue_name, p_message_id);
END;
$$;
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO pgmq.customer_onboarding_queue (message)
    VALUES (
      jsonb_build_object(
        'execution_id', (
...
GRANT ALL ON FUNCTION "public"."pgmq_delete_message"("p_queue_name" "text", "p_msg_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_delete_message"("p_queue_name" "text", "p_msg_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_delete_message"("p_queue_name" "text", "p_msg_id" bigint) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_ai_generation"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_ai_generation"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_ai_generation"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_customer_onboarding"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_customer_onboarding"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_customer_onboarding"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_location_discovery"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_location_discovery"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_location_discovery"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_location_sync"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_location_sync"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_location_sync"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_oauth_validation"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_oauth_validation"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_oauth_validation"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_response_approval"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_response_approval"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_response_approval"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_response_publishing"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_response_publishing"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_response_publishing"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_read_review_sync"("p_vt" integer, "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_read_review_sync"("p_vt" integer, "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_read_review_sync"("p_vt" integer, "p_qty" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_send_message"("p_queue_name" "text", "p_message" "jsonb", "p_delay_seconds" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_send_message"("p_queue_name" "text", "p_message" "jsonb", "p_delay_seconds" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_send_message"("p_queue_name" "text", "p_message" "jsonb", "p_delay_seconds" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."pgmq_send_response_publishing"("p_message" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."pgmq_send_response_publishing"("p_message" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."pgmq_send_response_publishing"("p_message" "jsonb") TO "service_role";
